-- Fix welcome bonus profile query to handle edge cases
-- This migration updates the wallet-operations function to handle profile queries better

-- Create a helper function to safely get or create profile
