-- Fix handle_player_claim function to use correct column names
-- The function was using 'name' and 'surname' but the players table uses 'first_name' and 'last_name'
