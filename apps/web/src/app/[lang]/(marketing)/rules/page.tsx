    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-purple-950 text-white">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                <h1 className="text-4xl font-bold mb-2 text-center">Οδηγός Παιχνιδιού NetProphet</h1>
                <p className="text-sm text-gray-300 font-semibold text-center mb-8">Πώς παίζεται – Τι ισχύει – Τι πρέπει να γνωρίζεις</p>
                ...
                <div className="space-y-8 text-sm text-gray-100">
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">1. Στόχος του Παιχνιδιού</h2>
                        <p>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">2. 🏆 Τύποι Αγώνων και Διοργανώσεων</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">3. Πώς κάνω Πρόβλεψη;</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">4. 💰 Νομίσματα (In-Game Currency)</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">5. 📊 Εικονικές Αποδόσεις (Virtual Odds)</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">6. 🎁 Ανταμοιβές & Συστήματα Πόντων</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">7. ⚡ Power-Ups</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">8. Leaderboard & Πόντοι</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">9. Ακύρωση Αγώνων ή Προβλέψεων</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">10. Προφίλ Παίκτη & Δεδομένα</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">11. Τεχνικά Θέματα & Ασφαλής Χρήση</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">12. Τι δεν είναι το NetProphet</h2>
                        <ul className="list-disc list-inside space-y-1">
