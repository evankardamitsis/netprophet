            ...
            <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid sm:grid-cols-2 md:grid-cols-5 gap-8 mb-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-slate-300 mb-4 font-semibold max-w-md">
                        ...
                        <div className="flex gap-2 mb-6">
                            <a
                                ...
                                className="p-2 text-slate-400 hover:text-yellow-300 transition-colors rounded-lg hover:bg-white/5"
                    ...
                    <div>
                        ...
                        <div className="text-xs text-slate-400 font-semibold">
                            ...
                            <span> &</span> <a href="https://www.monadlabs.gr/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 font-bold">Monad Labs E.E</a>
                        </div>
                    </div>
                </div>
            </div>
