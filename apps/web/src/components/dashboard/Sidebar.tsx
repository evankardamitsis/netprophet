        ...
        >
            {sidebarOpen ? (
                ...
                <div className="flex flex-col h-full p-4">
                    <Card className={`flex-1 overflow-hidden ${theme === 'dark' ? 'bg-[#23262F]' : 'bg-white'} min-w-0`}>
                ...
                <div className="flex flex-col h-full p-3">
                    ...
                    <div className="flex-shrink-0 pt-2">
                        <button
                            ...
                            className={`w-full p-2 rounded-lg flex items-center justify-center transition-colors cursor-pointer ${theme === 'dark'
