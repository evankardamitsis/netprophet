export interface Dictionary {
  ...
  profileSetup: {
    ...
    checking?: {
      ...
      completelyOptionalTitle?: string;
    };
    form: {
      title: string;
      description: string;
      aboutPlayerProfiles?: string;
      aboutPlayerProfilesDescription?: string;
    ...
    result: {
      ...
      claimButton?: string;
      notYouButton?: string;
      multipleMatchesBanner?: string;
      singleMatchBanner?: string;
