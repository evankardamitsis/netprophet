...
export default function NewPlayerPage() {
    ...
    const handleNumberChange = (field: keyof Player, e: React.ChangeEvent<HTMLInputElement>, parse: 'int' | 'float') => {
        ...
        updatePlayer(field, !Number.isNaN(n) ? n : '');
    };
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <Input
                                    ...
                                    type="number"
                                    min="0"
                                    value={(player as { currentStreak?: number | string }).currentStreak === '' ? '' : player.currentStreak}
                                    onChange={(e) => handleNumberChange('currentStreak', e, 'int')}
                                />
                            </div>
                            <div>
