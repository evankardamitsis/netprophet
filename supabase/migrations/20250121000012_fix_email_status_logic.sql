-- Fix email status logic to use pending/sent correctly
-- This migration updates the admin email function to use 'pending' status
...
COMMENT ON FUNCTION send_admin_alert_email IS 'Logs admin alert emails with pending status for automatic processing';
