-- Add welcome email template to the database
-- This creates the welcome email template for new users

-- First, delete any existing welcome email template
    ...
    <div class="container">
        ...
        <div class="welcome-section">
            <p class="welcome-text">
                ...
                Welcome to NetProphet - the ultimate platform for tennis prediction enthusiasts! 
                You''re about to embark on an exciting journey where you can predict real amateur tennis matches, 
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px; font-size: 12px;">
                This email was sent to {{user_email}} because you registered on NetProphet.<br>
