-- Update get_active_users_count function to support time period parameter
-- This allows active users to be calculated based on the selected time period filter
