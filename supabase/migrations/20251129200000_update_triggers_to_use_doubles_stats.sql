-- Update trigger functions to use doubles stats functions
-- This ensures doubles matches update doubles-specific stats (doubles_wins, doubles_losses, etc.)

-- Step 1: Update trigger function for match result inserts to use doubles stats
...
-- Step 2: Update trigger function for match result updates to use doubles stats
...
-- Step 3: Update trigger function for match result deletions to use doubles stats
